...
Vagrant.configure(2) do |config|
  ...
  # config.vm.define "vagrant_app" do |app|
  #   app.vm.box = "ubuntu/trusty64"
  #   app.vm.network "forwarded_port", guest: 8009, host: 8009
  # end
  
  # config.vm.define "vagrant_ldap" do |ldap|
  #   ldap.vm.box = "ubuntu/trusty64"
  #   ldap.vm.network "forwarded_port", guest: 80, host: 8081
  #   ldap.vm.network "forwarded_port", guest: 443, host: 8444
  # end
